...
<div className='flex items-center flex-wrap mt-[15px]'>
   ...
   <p className='text-[14px] text-[#9F9F9F] tracking-wide'>Size</p>
        <div className='flex items-center gap-4 flex-wrap'>
                ...
                <div className='w-[123px] rounded-[10px] border-[1px] border-[#00000080] flex justify-between overflow-hidden'>
                    ...
                    <div className='flex justify-center'>
                        <Link href="/Cartmain">
                        <button className='border-[1px] border-black px-12 py-[17px] rounded-[10px] flex items-center justify-center hover:text-black  hover:border-0' onClick={handleMenuClick}>Add To Cart</button>
                        </Link>
                    </div>

                    <div className='flex justify-center'>
                        <button className='border-[1px] border-black px-12 py-[17px] rounded-[10px] flex items-center justify-center hover:text-black  hover:border-0' onClick={handleMenuClick}>+ Compare</button>
                    </div>
                </div>
 ...
 <div className='mt-[54px] border-t border-[#D9D9D9] pt-12'>
            ...
            <div className='max-w-[1026px] mx-auto text-gray-500 space-y-[30px] py-[37px] p-4 sm:p-0 border-b border-[#D9D9D9]'>
 ...
 <div className=''>
            ...
            <div className='flex flex-wrap justify-center gap-[30px] mt-8 shadow-lg rounded-lg hover:shadow-cyan-400 '>
